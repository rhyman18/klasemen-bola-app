...
<div class="flex flex-col sm:flex-row">
    <div class="flex flex-col gap-6">
        <input id="club-name-1" type="text" name="clubName1" placeholder="Nama club 1" class="py-2 px-4 rounded-lg text-gray-700">
    ...
    <div class="flex flex-col gap-6">
        <input id="club-name-1" type="text" name="clubName1" placeholder="Nama club 2" class="py-2 px-4 rounded-lg text-gray-700">
        <input id="club-score-1" type="text" name="clubScore1" placeholder="Hasil score" class="py-2 px-4 rounded-lg text-gray-700">
    </div>
</div>
